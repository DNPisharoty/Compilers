...
class MySymTb
{
  ...
  public:
   ...
   char *type;
   Decl *child;
  MySymTb(Identifier *i, int s, char *t);
  MySymTb();
  MySymTb(Identifier *i, int s, char *t , Decl *c);
};
...
class Node 
{
  ...
  public:
    ...
    void Check(int level, List<Hashtable<MySymTb*>*> *head);
    virtual void CheckChildren(int level, List<Hashtable<MySymTb*>*> *head){}
    virtual void CheckNamedType(int level, List<Hashtable<MySymTb*>*> *head){}
