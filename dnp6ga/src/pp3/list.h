...
{             Nth(i)->SetParent(p); }
   ...
   void CheckAll(int l,List<Hashtable<MySymTb*>*> *h)
        
{
     
             //Hashtable<MySymTb*> *tb = h->Nth(0);
           
                for (int i = 0; i < NumElements(); i++){
	        Nth(i)->CheckChildren(l,h);    
      }
        }


void CheckNamedTypeAll(int l,List<Hashtable<MySymTb*>*> *h)

{
             ...
             //Hashtable<MySymTb*> *tb = h->Nth(0);
                ...
                for (int i = 0; i < NumElements(); i++){
                Nth(i)->CheckNamedType(l,h);
      }
        }


void CheckNamedTypeAll(int l,List<Hashtable<MySymTb*>*> *h,reasonT t)
