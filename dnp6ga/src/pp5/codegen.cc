...
Location *CodeGenerator::GenTempVar()
{
  ...
  result = new Location(fpRelative,-8-(tcount*4),temp);
...
Location * CodeGenerator::StoreVar( const char * st, Segment s)
{

   
         Location *x =  new Location(s,-8-(tcount*4),st); 
	  tcount++;
...
Location * CodeGenerator::StoreGlobalVar( const char * st, Segment s)
{
    static int gcount = 0;

         Location *x =  new Location(s,(gcount*4),st);
          gcount++;
